...
public class MainActivity2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        minute = (EditText) findViewById(R.id.dk);
        second = (EditText) findViewById(R.id.sn);
    ...
    public void onClick(View view) {
        if (view == lock) {
            ...
            if (active) {
                String dk = minute.getText().toString();
                String sn = second.getText().toString();
                if (sn.equals("")) {
                    sn = "0";
                }
                if (dk.equals("")) {
                ...
                Toast.makeText(this, "You must first allow.", Toast.LENGTH_SHORT).show();
            }
        ...
        switch(requestCode) {
            case RESULT_ENABLE :
                if (resultCode == Activity.RESULT_OK) {
                    Toast.makeText(MainActivity2.this, "Allowed.", Toast.LENGTH_SHORT).show();
                } else {
