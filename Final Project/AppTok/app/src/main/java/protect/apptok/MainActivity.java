...
{
    private final static String TAG = "AppTok";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _soundMap = ImmutableMap.<String, Integer>builder()
                .put(getResources().getString(R.string.lullaby1), R.raw.lullaby_1)
                .put(getResources().getString(R.string.lullaby2), R.raw.lullaby_2)
                .put(getResources().getString(R.string.lullaby3), R.raw.lullaby_3)
                .put(getResources().getString(R.string.lullaby4), R.raw.lullaby_4)
                .put(getResources().getString(R.string.lullaby5), R.raw.lullaby_5)
                .put(getResources().getString(R.string.lullaby6), R.raw.lullaby_6)
                .put(getResources().getString(R.string.lullaby7), R.raw.lullaby_7)
                .put(getResources().getString(R.string.lullaby8), R.raw.lullaby_8)
                .put(getResources().getString(R.string.lullaby9), R.raw.lullaby_9)
                .put(getResources().getString(R.string.lullaby10), R.raw.lullaby_10)
                .build();
    ...
    private void displayAboutDialog()
    {
        ...
        String html =
            ...
            "<img src=\"file:///android_res/mipmap/logo_laucehr.png\" alt=\"" + appName + "\"/>" +
            "<h1>" +
